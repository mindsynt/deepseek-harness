...
import type {
  ArchivedFilter, GroupNode, SessionNode, SessionOrderBy, SessionRowState, WorkspaceRow,
} from '../tree.ts'
import {
...
export function WorkspaceBrowser({
  ...
  }), [branches, currentBlank, list.byId, orderBy, orderState, sessionOrderByAccount, workspaces])
