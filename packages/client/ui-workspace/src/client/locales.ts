...
export const zh = {
  ...
  'menu.addWorkspaceOn': '在 {host} 上添加工作区…',
  'host.local': '本机',
  'picker.loading': '正在加载工作区…',
  'conflict.named': '已存在名为“{name}”的工作区。',
  'folderError.title': '无法打开文件夹',
  'folderError.retry': '重新选择',
  'hostWorld.disconnected': '所选远程主机的执行世界已断开，相关操作不可恢复。请移除后重新添加该主机，或改用本机。',
  'rename': '重命名',
...
export const en = {
  ...
  'menu.addWorkspaceOn': 'Add workspace on {host}…',
  'host.local': 'This machine',
  'picker.loading': 'Loading workspaces…',
  'conflict.named': 'A workspace named “{name}” already exists.',
  'folderError.title': 'Couldn’t open folder',
  'folderError.retry': 'Choose again',
  'hostWorld.disconnected': 'The execution world of the selected remote host is disconnected, so operations against it are unrecoverable. Remove and re-add that host, or use this machine.',
  'rename': 'Rename',
