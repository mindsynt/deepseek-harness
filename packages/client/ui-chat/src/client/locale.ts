...
export const zh = {
  ...
  'composerCost.loading': '模型花费汇总中…',
  'composerCost.label': '模型花费 {amount}',
  'composerCost.month': '月份',
  'composerCost.monthAll': '全部',
  'composerCost.note': '按各会话中该模型请求发生时的配置价格估算；缓存写入按未命中价格计费',
  'composerCost.scope': '范围',
  'composerCost.scopeAll': '全部会话',
  'composerCost.scopeCurrent': '仅当前会话',
  'composerCost.scopeMain': '仅主会话',
  'composerCost.title': '模型花费',
  'message.turnUsage.cost': '费用',
  'message.turnUsage.unpriced': '未配置价格',
...
export const en = {
  ...
  'composerCost.loading': 'Summarizing model spend…',
  'composerCost.label': 'Model spend {amount}',
  'composerCost.month': 'Month',
  'composerCost.monthAll': 'All time',
  'composerCost.note': "Estimated with the model's configured price at each request; cache-write tokens use the miss price",
  'composerCost.scope': 'Scope',
  'composerCost.scopeAll': 'All sessions',
  'composerCost.scopeCurrent': 'This session only',
  'composerCost.scopeMain': 'Main sessions only',
  'composerCost.title': 'Model spend',
  'message.turnUsage.cost': 'Cost',
  'message.turnUsage.unpriced': 'Price not set',
