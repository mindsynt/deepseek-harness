...
export const en = {
  ...
  modelImageInherit: 'Inherit',
  modelImageText: 'Text only',
  modelImageTextImage: 'Text and images',
  modelReasoning: 'Reasoning effort',
  modelReasoningInherit: 'Inherit',
  modelReasoningDisabled: 'Disabled',
  modelReasoningCustom: 'Custom levels',
  modelReasoningLevel: 'Level',
  modelReasoningWire: 'Wire value',
  modelReasoningHint: 'Checked levels appear in the model picker; each level beyond "off" needs the wire value sent for it. Blank "off" sends nothing.',
  modelReasoningOffPlaceholder: 'blank: send nothing',
  modelReasoningWirePlaceholder: 'wire value',
  addModel: 'Add model',
  ...
  modelInputInvalid: 'Image input must list only "text" and "image".',
  modelEffortsInvalid: 'Reasoning levels must be a map of levels to their wire values.',
  modelEffortsUnknownLevel: 'Reasoning levels contain an unknown level name.',
  modelEffortsOffValue: 'Leave "off" blank to send nothing, or give it a wire value.',
  modelEffortsLevelValue: 'Each reasoning level beyond "off" needs the wire value to send.',
  modelEffortsOnlyOff: 'Declare at least one thinking level beyond "off", or disable reasoning.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelImageInherit: '继承',
  modelImageText: '仅文本',
  modelImageTextImage: '文本和图片',
  modelReasoning: '推理等级',
  modelReasoningInherit: '继承',
  modelReasoningDisabled: '关闭',
  modelReasoningCustom: '自定义等级',
  modelReasoningLevel: '等级',
  modelReasoningWire: '发送值',
  modelReasoningHint: '勾选的等级会出现在模型选择器中；除 “off” 外的每个等级都要填写其发送值，“off” 留空表示不发送。',
  modelReasoningOffPlaceholder: '留空表示不发送',
  modelReasoningWirePlaceholder: '发送值',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  modelInputInvalid: '图片输入只能包含 “text” 和 “image”。',
  modelEffortsInvalid: '推理等级必须是等级到发送值的映射。',
  modelEffortsUnknownLevel: '推理等级包含未知的等级名称。',
  modelEffortsOffValue: '“off” 留空表示不发送，或给它填写发送值。',
  modelEffortsLevelValue: '除 “off” 外的每个推理等级都需要填写发送值。',
  modelEffortsOnlyOff: '请至少声明一个 “off” 之外的思考等级，或关闭推理。',
