...
源码：[`packages/api/workspace-controller/src/index.ts:37`](../packages/api/workspace-controller/src/index.ts)
...
来源： [`packages/api/workspace-files/src/index.ts:84`](../packages/api/workspace-files/src/index.ts)
...
来源： [`packages/fs/fs-local/src/index.ts:47`](../packages/fs/fs-local/src/index.ts)
...
来源：[`packages/ssh/helper-installer/src/index.ts:46`](../packages/ssh/helper-installer/src/index.ts)
...
来源：[`packages/ssh/host-credentials/src/index.ts:74`](../packages/ssh/host-credentials/src/index.ts)
...
来源： [`packages/host/directory-picker-browse/src/index.ts:210`](../packages/host/directory-picker-browse/src/index.ts)
...
Depends on: [`LlmModelPricing`](../packages/llm/llm/src/index.ts) · [`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · [`SystemPromptUpdate`](../packages/llm/llm/src/index.ts) · `Volatile` (`@deepseek-ai/cordis`)
...
Depends on: `Api` (`@earendil-works/pi-ai`) · `CacheRetention` (`@earendil-works/pi-ai`) · [`LlmModelPricing`](../packages/llm/llm/src/index.ts) · `Model` (`@earendil-works/pi-ai`) · `ModelThinkingLevel` (`@earendil-works/pi-ai`) · `OpenAICompletionsCompat` (`@earendil-works/pi-ai`) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets` (`@earendil-works/pi-ai`) · `Transport` (`@earendil-works/pi-ai`) · `Volatile` (`@deepseek-ai/cordis`)
...
来源： [`packages/spill/spill-local/src/index.ts:39`](../packages/spill/spill-local/src/index.ts)
...
需要：`sshHelperInstaller` · `sshHostCredentials` · `storageDomain`
...
来源：[`packages/ssh/host-registry/src/index.ts:74`](../packages/ssh/host-registry/src/index.ts)
...
来源： [`packages/fs/tool-str-replace-editor/src/index.ts:537`](../packages/fs/tool-str-replace-editor/src/index.ts)
...
- `@deepseek-ai/dsh-hosts-controller` — 需要 `remoteHosts` · `sshHostCredentials`（[`packages/api/hosts-controller/src/index.ts`](../packages/api/hosts-controller/src/index.ts)）
