...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  ssh: 'ssh.md',
  sshHelperInstaller: 'ssh.md',
  sshHostCredentials: 'ssh.md',
  remoteHosts: 'ssh.md',
  hostsController: 'ssh.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  remoteHostSelection: 'client-side workspace-creation host selection — packages/client/ui-remote-hosts/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RemoteHelperArtifact: 'ssh.md',
  RemoteCommandResult: 'ssh.md',
  RemoteCommandRunner: 'ssh.md',
  RemoteCommandRunOptions: 'ssh.md',
  HelperInstallRequest: 'ssh.md',
  HelperInstallation: 'ssh.md',
  RemoteHostId: 'ssh.md',
  RemoteHostEntryConfig: 'ssh.md',
  RemoteHostSpec: 'ssh.md',
  RemoteHostProvisionRequest: 'ssh.md',
  RemoteHostLoginProvisionRequest: 'ssh.md',
  RemoteHostHandle: 'ssh.md',
  RemoteHostRecord: 'ssh.md',
  RemoteHostLogin: 'ssh.md',
  ControlledSshIdentity: 'ssh.md',
  HostKeyEndpoint: 'ssh.md',
  SshHostCredentials: 'ssh.md',
  RemoteHostsListValue: 'ssh.md',
  RemoteHostAddRequest: 'ssh.md',
  RemoteHostAddValue: 'ssh.md',
  RemoteHostRemoveRequest: 'ssh.md',
  RemoteHostRemoveValue: 'ssh.md',
  RemoteHostTestRequest: 'ssh.md',
  RemoteHostTestValue: 'ssh.md',
  RemoteHostsFollowFrame: 'ssh.md',
  ScopeKey: 'scope.md',
  Scoped: 'scope.md',
  ...
  WorkspaceBranchesValue: 'workspace.md',
  WorkspaceBranchView: 'workspace.md',
